...
export const { command, aliases, describe, builder, handler } =
  createCommandModule({
    ...
    describe: "Encode call data for Airdrop.claimAndDelegate",
...
export function encodeClaimAndDelegate(
  ...
  const optimisticRewardsInterface = new Interface(Airdrop__factory.abi);
  return optimisticRewardsInterface.encodeFunctionData("claimAndDelegate", [
