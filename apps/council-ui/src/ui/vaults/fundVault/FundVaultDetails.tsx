...
import { FundVaultStatsRow } from "src/ui/vaults/fundVault/FundVaultStatsRow";
...
interface FundVaultDetailsProps {
  address: string;
}

export function FundVaultDetails({
  address,
}: FundVaultDetailsProps): ReactElement {
