...
export const mainnetCouncilConfig: CouncilConfig = {
    ...
    vaults: [
      {
        ...
        type: "LockingVault",
        descriptionURL:
          "https://docs-delv.gitbook.io/element-protocol-docs/governance-council/council-protocol-smart-contracts/voting-vaults/locking-vault",
      },
      {
        name: "Vesting Vault",
        ...
        type: "VestingVault",
        descriptionURL:
          "https://docs-delv.gitbook.io/element-protocol-docs/governance-council/council-protocol-smart-contracts/voting-vaults/vesting-vault",
      },
    ],
    proposals: {
      0: {
  ...
  gscVoting: {
    ...
    vault: {
      ...
      descriptionURL:
        "https://docs-delv.gitbook.io/element-protocol-docs/governance-council/council-protocol-smart-contracts/voting-vaults/governance-steering-council-gsc-vault",
    },
    proposals: {
      0: {
        descriptionURL:
